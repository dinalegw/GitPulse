    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 lg:py-28 bg-bg-card-2/50 border-y border-border-subtle"><div className="section-container"><div className="max-w-5xl mx-auto"><div className="text-center mb-10"><h3 className="heading-3 mb-3">Choose your path</h3><p className="text-lead">Use GitPulse from a release, or contribute to the open-source project.</p></div>
        <div className="grid gap-6 md:grid-cols-2">
          <div className="card p-8"><span className="badge badge-success">USE GITPULSE</span><h4 className="heading-3 mt-3 mb-3">Install the CLI</h4><p className="text-text-muted mb-4 text-sm">Install GitPulse without cloning the source repository. The bootstrap installer handles prerequisites and setup.</p><p className="text-text-muted mb-2 text-sm font-medium">Linux / macOS</p><div className="code-block mb-4"><pre className="font-mono text-xs whitespace-pre-wrap break-all"><code>{`curl -fsSL https://start-gitpulse.vercel.app/install.sh | sh\ngitpulse init\ngitpulse doctor`}</code></pre></div><p className="text-text-muted mb-2 text-sm font-medium">Windows PowerShell</p><div className="code-block mb-4"><pre className="font-mono text-xs whitespace-pre-wrap break-all"><code>{`iwr -useb https://start-gitpulse.vercel.app/install.ps1 | iex\ngitpulse init\ngitpulse doctor`}</code></pre></div><Link href="/playground" className="link text-sm">Or try the playground first →</Link></div>
